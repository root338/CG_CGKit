...
- (NSString *)transformStringWithFormatter:(CGDateForStringFormatter)stringFormatter
{
    ...
    switch (stringFormatter) {
        case CGDateForStringFormatterDefault:
            formatterStr = [NSString stringWithFormat:@"%04li-%02li-%02li %02li:%02li-%02li", (long)dateComponent.year, dateComponent.month, dateComponent.day, (long)dateComponent.hour, dateComponent.minute, dateComponent.second];
            break;
        case CGDateForStringFormatterTimer:
            formatterStr = [NSString stringWithFormat:@"%02li:%02li-%02li", (long)dateComponent.hour, dateComponent.minute, dateComponent.second];
            break;
        case CGDateForStringFormatterYear:
            formatterStr = [NSString stringWithFormat:@"%04li-%02li-%02li", (long)dateComponent.year, dateComponent.month, dateComponent.day];
            break;
        default:
            break;
    }
