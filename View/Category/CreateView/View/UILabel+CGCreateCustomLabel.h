...
+ (instancetype)cg_createLabelWithText:(nullable NSString *)text font:(UIFont *)font textColor:(UIColor *)textColor textAlignment:(NSTextAlignment)textAlignment;

/** 创建UILabel，设置（文本，字体，字体颜色，对齐方式, 背景色） */
+ (instancetype)cg_createLabelWithText:(nullable NSString *)text font:(UIFont *)font textColor:(UIColor *)textColor textAlignment:(NSTextAlignment)textAlignment backgroundColor:(UIColor *)backgroundColor;
