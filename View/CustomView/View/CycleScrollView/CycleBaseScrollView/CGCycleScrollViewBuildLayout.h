...
@property (nullable, nonatomic, strong, readonly) CGCycleCellConfigModel *firstCellConfig;
@property (nullable, nonatomic, strong, readonly) CGCycleCellConfigModel *lastCellConfig;

@property (nullable, nonatomic, strong, readonly) NSArray<CGCycleCellConfigModel *> *allCellsConfigArray;

/** 设置重新刷新后 滑动视图 contentOffset 的值 */
- (CGPoint)setupScrollViewDidReloadContentOffset;
/** 设置重新刷新后 滑动视图 contentSize 的值 */
