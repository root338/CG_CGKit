...
/** 文本标题外边界 @param 默认UIEdgeInsetsZero，上下居中 @warning right值无效*/
...
/** 按钮标题外边界 @param 默认UIEdgeInsetsZero，上下居中 @warning left值无效 */
...
/** 文本标题与按钮之间的间距 @param 默认为0，两端对齐 */
@property (nonatomic, assign) CGFloat space;

/** 是否两端对齐 @param 默认为NO，使用两端对齐 */
