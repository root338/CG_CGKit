 ...
 *  @param 实现方式1： 父视图大小确定，通过父视图大小，外边距和子视图水平，垂直间距来计算子视图大小。从而添加子视图
 *  @param 实现方式2： 父视图宽度确定，通过父视图大小，外边距和子视图水平间距计算子视图宽度，通过子视图宽度和宽高比计算子视图高度，来添加子视图
 */
...
/** 子视图之间的宽度/高度的比例 @param itemScal = width / height */
